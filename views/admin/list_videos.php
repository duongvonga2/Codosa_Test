<?php 
    ...
    $list_videos = dbGetAllRows('videos'); //get all rows in table videos
?>
	<div class="container-fluid">
		...
		<?php 
			while($video = $list_videos->fetch_assoc()){ 
				$title=dbGetRowsWithCondition('titles','id=' . $video['title_id'])->fetch_assoc(); //get data in table titles with title_id condition
		...
		?>
				...
				<a class="row col-md-6 border border-primary offset-md-3 mt-3 px-2 py-2 btn-outline-primary" href="/Codosa_Test/views/admin/video_detail.php?id=<?php echo $video['id'] ?>">
					...
					<div class="col-sm-4 center-items">
						<div>
